        ...
        public List<RentalDetailDto> GetRentalDetails()
        {
            using (RentaCarContext context = new RentaCarContext())
            {
                var result = from r in context.Rentals join c in context.Car on r.CarId equals c.CarID
                             ...
                             from car in context.Car join b in context.Brands on c.BrandID equals b.BrandID
                             join color in context.Colors on car.ColorID equals color.ColorId
                             from us in context.Users join company in context.Customers on us.UserID equals company.userID
